...
conda install -y -c conda-forge numpy=1.26.4 scipy pandas scikit-learn opencv matplotlib seaborn
...
# 실행
python scripts/evaluate.py     --checkpoint checkpoints/checkpoint_best.pt     --max-batches 10     --save-samples 